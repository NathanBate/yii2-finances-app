<template>
    <div>
      ...
      <q-form @submit="addIncome" class="q-gutter-md q-mt-lg">
        <PayerList
          @updateNewPayer="(value) => { newPayer = value }"
          @updatePayer="(value) => { incomeSearch = value }"
        />
